    ...
    return (
        <div className="flex flex-col bg-eerieBlack items-center">
            ...
            <div id="project-content" className="w-full px-4">
                ...
                <ul key="techs" id="techs" className={`grid ${getGridColsClass()} gap-6 mt-10`}>
                ...
                {hasVideo && (
                    <div className="w-full mt-10 mb-20">
                        ...
                        {project.paragraphs.filter(p => p.title.includes('Watch')).map(watchVideo => {
                            ...
                            return (
                                <div key={watchVideo.title}
                                     className="aspect-video sm:aspect-w-16 sm:aspect-h-9 w-full max-w-screen-md mx-auto mb-6">
                                    <iframe
                ...
                <h1 className="flex text-2xl sm:text-xl font-bold font-mova mt-10 mx-auto items-center justify-center">OTHER
                    PROJECTS</h1>
