...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} w-full max-w-[100vw] flex items-center py-2 fixed 
      top-0 z-30  sm:opacity-[0.97] xxs:h-[12vh] shadow-2xl`} style={{ backgroundColor: "#003739" }} >
