...
const projects = [{
    ...
    repo: 'https://github.com/alexmadaras00/TripPlanner',
    image: trip_palette,
    paragraphs: [{
        title: 'Problem',
        image: problem,
    ...
    id: 'project-ell',
    name: "Erasmus in Lisbon - Hackaton App",
    type: 'Android Application',
    description: 'Android App developed during a 1 week Hackaton organized by IADE Creative University.',
    image: ell,
    technologies: [{
        name: 'Kotlin', icon: kotlin,
    }, {
    ...
    repo: 'https://github.com/alexmadaras00/Erasmus-In-Lisbon-Hackaton-App',
    paragraphs: [{
        title: 'Problem',
        image: problem,
    ...
    name: 'VRADES',
    type: 'Android Application',
    description: 'Introducing my Bachelor Thesis project - an Android App that detects emotions and helps users establish healthier habits with personalized recommendations. Join us on the journey towards better emotional health and wellbeing today!',
    technologies: [{
        name: 'Android Studio', icon: android_studio,
    }, {
        name: 'Kotlin', icon: kotlin,
    ...
    image: vrades,
    repo: 'https://github.com/alexmadaras00/VRADES',
    paragraphs: [{
        title: 'Problem',
        image: problem,
    ...
    // },
    {
        ...
        name: 'SpyForHire',
        type: 'Android Application',
        description: 'SpyForHire: The companion app for the Windows game EIA. Developed using Kotlin, SQL, and NodeJS as part of a multiplatform project during my Erasmus Mobility.',
        technologies: [{
            name: 'Android Studio', icon: android_studio,
        }, {
            name: 'Kotlin', icon: kotlin,
